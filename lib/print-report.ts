...
<div class="rep-foot">صادر عن نظام RusoomPay المحاسبي للمدارس · ${now.getFullYear()}</div>
  ...
  // انتظر تحميل خط Cairo فعلياً قبل الطباعة —
  // الطباعة قبل اكتمال الخط تُنتج أحرفاً بخط بديل لا يدعم العربية جيداً في PDF.
  ...
  if (fonts && fonts.ready) {
    ...
    // احتياط: لو تأخّر تحميل الخط أكثر من 3 ثوانٍ، اطبع على أي حال
