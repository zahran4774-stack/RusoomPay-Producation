...
export default function SchoolCopilot({ data, sym, firstName }: { data: CopilotData; sym: string; firstName: string }) {
  ...
  return (
    <section
      ...
      {recommendations.length > 0 && (
        <div>
          <h3 style={{ fontSize: 12, fontWeight: 700, color: '#6B7A90', textTransform: 'uppercase', letterSpacing: 0.4, margin: '0 0 10px' }}>إجراءات موصى بها</h3>
