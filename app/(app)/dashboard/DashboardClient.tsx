  ...
  return (
    <div style={{ maxWidth: 1080, margin: '0 auto' }} dir="rtl">
      <style>{`
        ...
        @keyframes epPulse{
          0%,100%{box-shadow:0 0 0 0 rgba(192,57,43,.45); background:#FDECEA}
          50%{box-shadow:0 0 0 10px rgba(192,57,43,0); background:#FBD9D3}
        }
        .ep-alert-urgent .ep-alert-ico{animation:epIcoPulse 1.4s ease-in-out infinite}
        @keyframes epIcoPulse{
