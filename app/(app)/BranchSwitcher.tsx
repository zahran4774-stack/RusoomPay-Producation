    ...
    <div style={{ margin: '4px 14px 10px' }}>
      <div style={{ position: 'relative' }}>
        ...
        >
          ...
          <span style={{ flex: 1, fontWeight: 700, fontSize: 13.5, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', color: '#D4A017' }}>
        ...
        {open && (
          <div style={{
            ...
            boxShadow: '0 6px 20px rgba(10,37,68,.12)', zIndex: 50, overflow: 'hidden',
          }}>
            {branches.map((b) => (
              <button
                key={b.school_id}
