'use client'
// إعدادات الحساب البنكي للمدرسة — للمدير فقط (منقول من صفحة الرسوم إلى الإعدادات والأمان)
// يُربط بخيارات دفع رسوم الطلاب: عند تفعيله، يرى ولي الأمر هذا الحساب للتحويل
// لاحقاً: نفس هذا القسم سيُستخدم للربط مع بوابة ثواني (Thawani) للدفع بالبطاقة
