...
export default function LoginPage() {
  ...
  return (
    <div className="lp-root" dir="rtl">
      {/* تحميل الصورة مسبقاً بأولوية عالية — تكون جاهزة قبل ظهورها فلا قفزة */}
      {/* eslint-disable-next-line @next/next/no-head-element */}
      <link rel="preload" as="image" href="/hero-school.jpg" fetchPriority="high" />
      ...
      <style jsx>{`
        ...
        .lp-bg {
          position: absolute;
          inset: 0 0 128px 0;
          /* لون احتياطي هادئ يظهر ريثما تُحمّل الصورة — يمنع الوميض الأبيض */
          ...
          z-index: 0;
          /* ظهور ناعم بدل القفزة المفاجئة عند وصول الصورة */
          animation: bgFade .6s ease both;
        }
