...
const TEMPLATES = {
  ...
  parent_invite: 'HX2a05e89eb4f7022b2b3b39442c82e337', // دعوة تفعيل حساب (parentinvite5 — Call to Action، بدون متغير في بداية/نهاية النص) — {{1}} اسم المدرسة بدون كلمة "مدرسة" {{2}} رقم هاتف
